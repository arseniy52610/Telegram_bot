...
async def admin(message: Message):
    await message.answer("<b>✅ Вы вошли в админ панель</b>", parse_mode='HTML' ,reply_markup=admin_keyboard())
    try:
...
async def send_mailing(call: CallbackQuery, state: FSMContext):
    await call.answer()
    await call.message.edit_text("✍️ Введите текст или фото рассылки", reply_markup=admin_cancel_keyboard())
